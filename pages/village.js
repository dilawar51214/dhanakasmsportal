...
//   const {user,loading} = useUser();
  ...
  const addVillage =async(event)=>{
    ...
    setVillage();
    setMessage("Village Record Added Successfully")
    setLoader(false)
    setTimeout(() => {
  ...
  const Auth = getAuth();
    ...
    <div className="w-full bgcolor min-h-screen">
        <div className="w-full justify-center items-center bgimageVillage flex h-full">
                ...
                <div className="w-80 flex justify-center items-center py-5 blurbg flex-col lg:w-3/4 rounded-2xl">
                    ...
                    <p className="cursor-pointer w-[15px]">
                        ...
                        <h1 className=" my-3 font-sans font-semibold text-2xl text-black">
                            ...
                            <form onSubmit={addVillage} >
                            <div className="flex flex-col w-72 lg:w-80 bg-white py-3 items-center">
                                 <p className='w-full justify-start'>Village Name</p>
                                <input required onChange={(e)=>{setVillage(e.target.value)}} type="text" className="w-full p-4 h-[30px] rounded-lg border-[1px] border-black outline-none"/>
